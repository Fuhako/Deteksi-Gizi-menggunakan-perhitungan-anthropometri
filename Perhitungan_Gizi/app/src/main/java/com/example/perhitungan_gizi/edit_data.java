...
public class edit_data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tampilData = findViewById(R.id.idBack);
        tampilData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(edit_data.this, TampilkanData.class);
        ...
        ArrayAdapter<CharSequence> adapterjk = ArrayAdapter.createFromResource(edit_data.this, R.array.jeniskelamin, android.R.layout.simple_spinner_item);
        adapterjk.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        jeniskelamin.setAdapter(adapterjk);

        ArrayAdapter<CharSequence> adapterpu = ArrayAdapter.createFromResource(edit_data.this, R.array.posisiukur, android.R.layout.simple_spinner_item);
    ...
    private void Database() {
        ...
        if (Nama.equals("") || Umur.equals("") || BB.equals("") || PB.equals("")) {
            Toast.makeText(edit_data.this, "Data Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
        } else {
            dbhelper.updateData(values, id);
            Toast.makeText(edit_data.this, "Data Berhasil Tersimpan", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
    ...
    private void getData() {
        ...
        if (cursor.moveToFirst()) {
            ...
            editText_BeratBadan.setText(Bb);
            editText_PanjangBadan.setText(Pb);
            ...
            if (PU.equals("Terlentang")) {
                posisiukur.setSelection(0);
            } else if (PU.equals("Berdiri")) {
                posisiukur.setSelection(1);
            }
        }
    }
